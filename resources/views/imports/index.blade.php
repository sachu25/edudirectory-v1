    ...
    <ul class="nav nav-pills mb-4 bg-white p-2 rounded shadow-sm" id="importTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active fw-semibold" id="unified-tab" data-bs-toggle="pill" data-bs-target="#unified" type="button" role="tab" aria-controls="unified" aria-selected="true">
                <i class="fas fa-file-invoice me-2 text-primary"></i>Unified Import (Colleges & Contacts)
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link fw-semibold" id="colleges-tab" data-bs-toggle="pill" data-bs-target="#colleges" type="button" role="tab" aria-controls="colleges" aria-selected="false">
                <i class="fas fa-university me-2 text-success"></i>Colleges Only
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link fw-semibold" id="contacts-tab" data-bs-toggle="pill" data-bs-target="#contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">
                <i class="fas fa-address-book me-2 text-info"></i>Contacts Only
            </button>
        </li>
    </ul>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <p class="text-muted small mb-4">Upload a combined Excel/CSV file to import both colleges and contacts simultaneously. If a college doesn't exist, it will be automatically created using our duplicate prevention system.</p>
                ...
                <div class="col-md-6">
                    <div class="card h-100 bg-light border-0 shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    <span class="badge bg-primary mb-2">College Data</span>
                            ...
                            <div class="alert alert-warning border-0 small mb-0">
                                <i class="fas fa-exclamation-triangle me-2 text-warning"></i> <strong>Note:</strong> Multiple contacts for the same college will be linked correctly under one college entry automatically.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-pane fade" id="colleges" role="tabpanel" aria-labelledby="colleges-tab">
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-header bg-white py-3 border-0">
                            <h6 class="mb-0 fw-bold text-dark"><i class="fas fa-upload text-success me-2"></i> Upload Colleges Sheet</h6>
                        </div>
                        <div class="card-body">
                            <p class="text-muted small mb-4">Upload an Excel/CSV file containing only college records. Existing entries will be updated without duplicates.</p>
                            
                            <form action="{{ route('imports.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4">
                                    <label for="college_file" class="form-label fw-semibold small">Select Colleges File (Excel/CSV)</label>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <button type="submit" class="btn btn-success px-4 text-white"><i class="fas fa-file-import me-2"></i> Import Colleges</button>
                                    <a href="{{ route('colleges.download-template') }}" class="btn btn-outline-success btn-sm"><i class="fas fa-download me-1"></i> Download Template</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card h-100 bg-light border-0 shadow-sm">
                        <div class="card-body p-4">
                            <h6 class="fw-bold mb-3 text-dark"><i class="fas fa-info-circle text-success me-2"></i> College Format Instructions</h6>
        ...
        <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-header bg-white py-3 border-0">
                            <h6 class="mb-0 fw-bold text-dark"><i class="fas fa-upload text-info me-2"></i> Upload Contacts Sheet</h6>
                        </div>
                        <div class="card-body">
                            <p class="text-muted small mb-4">Upload an Excel/CSV file containing only contact person records. This requires the associated colleges to already exist in the database.</p>
                            ...
                            <form action="{{ route('contacts.import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <button type="submit" class="btn btn-info px-4 text-white"><i class="fas fa-file-import me-2"></i> Import Contacts</button>
                                    <a href="{{ route('contacts.download-template') }}" class="btn btn-outline-info btn-sm"><i class="fas fa-download me-1"></i> Download Template</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card h-100 bg-light border-0 shadow-sm">
                        <div class="card-body p-4">
                            <h6 class="fw-bold mb-3 text-dark"><i class="fas fa-info-circle text-info me-2"></i> Contact Format Instructions</h6>
                            <p class="small text-muted">Please ensure your sheet contains a header row with the following column names:</p>
                            
                            <ul class="small text-muted ps-3 mb-4">
                                <li><code>college_name</code> (Required: must match existing college in the DB)</li>
